...
class EscapeRoomGame:
    ...
    def create_game(self, cheat=False):
        ...
        key = EscapeRoomObject("key",visible=True,gettable=True)
        ...
        room["container"]  = create_container_contents(player, door,key, clock, mirror, hairpin, chest)
        ...
        chest.triggers.append(lambda obj, cmd,*args:(cmd == "look") and hammer.__setitem__("visible",True))
