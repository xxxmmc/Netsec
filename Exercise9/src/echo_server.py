        ...
        def data_received(self, data):
            ...
            for gamePacket in d.nextPackets():
                if isinstance(gamePacket,GameCommandPacket):
                    ...
                    print("Game started")
                    gameRequirePacket = create_game_require_pay_packet('9821389123',"ymao22_account",15)
                    ...
                    print("Game started new")
                     ...
                     print("receiveGamePaypacket")
                     print(receipt)
                     print(receipt_sig)
                     self.game = escaperoomxr.EscapeRoomGame(output = self.send)
...
if __name__ == "__main__":
        ...
        coro = playground.create_server(EchoServer,'localhost',21012)
