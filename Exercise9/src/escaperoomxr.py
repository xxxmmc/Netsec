...
class EscapeRoomCommandHandler:
    ...
    def _cmd_open(self, open_args):
        ...
        if object.name == "curtain" and object["openable"] == False:
            self.output("Because you are locked. You have to decipher the codedlock!The ciphertext is BCDEFG. The plaintext is ABCDEF. Input the codedlock with key. The key is one character. Hurry up man, time is running out!")
...
class EscapeRoomGame:
    ...
    def start(self):
        self.status = "playing"
        self.output("Where are you? You don't know how you got here... Were you kidnapped or were you dreaming? "
                    + "And you are locked by a codelock. There is a codebook. The plaintext is 'ABCDEF'. The ciphertext is 'BCDEFG'. You should input codedlock with key to unlock it. \"input k\".The key is one character."
