...
certPath = "/home/student_20194/net/BitPoints-Bank-Playground3/src/bank.cert"
...
async def makepay(src, dst, amount, memo):
    amount = int(amount)
    username = bank_username 
    password = "Xuan_825427621"
    ...
    if result:
        ...
        return True, result.Receipt, result.ReceiptSignature
